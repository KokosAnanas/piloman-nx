...
Общение ведётся только на **русском языке**. В коде пиши пояснительные комментарии со ссылками на официальную документацию. Приложение адаптирована под мобильные телефоны
